<x-layouts.app>
    ...
    <div class="product-details-area pt-4 pb-100px">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                    ...
                    <div class="swiper-container zoom-top">
                        <div class="swiper-wrapper">
                            @foreach ($product->item->images as $product_item_image)
                                <div class="swiper-slide zoom-image-hover">
                                    <img class="img-responsive m-auto" src="{{ $product_item_image->product_item_image_path }}"
                                        alt="">
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content ml-25px">
                        ...
                        <div class="pricing-meta">
                            <ul class="d-flex">
                                <li class="new-price">${{ $product->item->product_item_price }}</li>
                            </ul>
                        </div>
                        ...
                        <div class="stock mt-30px">
                            <span class="avallabillty">Availability: <span class="in-stock"><i
                                        class="fa fa-check"></i>{{ $product->item->inStock ? 'In Stock' : '' }}</span></span>
                        </div>
                        <p class="mt-30px mb-0">{{ $product->product_description }}</p>
                        <div class="pro-details-quality">
                            <form class="d-flex" action="{{route('cart.add')}}" method="POST">
                                @csrf
                                <div class="cart-plus-minus">
                                    <input class="cart-plus-minus-box" type="text" name="quantity_to_add" value="1" />
                                </div>
                                <div class="pro-details-cart">
                                    <input type="hidden" name="product_item_id" value="{{ $product->item->id }}">
                                    <button title="Add To Cart" class="add-cart">Add
                                        To Cart</button>
                                </div>
                            </form>
                            <div class="pro-details-cart">
