<x-layouts.home>
    ...
    <div class="product-details-area pt-4 pb-4">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                    ...
                    <div class="swiper-container zoom-top">
                        <div class="swiper-wrapper">
                            @foreach ($productItem->product->images as $productImage)
                                <div class="swiper-slide zoom-image-hover">
                                    <img class="img-responsive m-auto" src="{{ $productImage->product_image_path }}"
                                        alt="">
                                </div>
                            @endforeach
                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content ml-25px">
                        <h2>{{ $productItem->product->product_name }}</h2>
                        <div class="pricing-meta">
                            <ul class="d-flex">
                                <li class="new-price">$ {{ $productItem->product_item_price }}</li>
                            </ul>
                        </div>
                        ...
                        {{-- <div class="stock mt-30px">
                            <span class="avallabillty">Availability: <span class="in-stock"><i
                                        class="fa fa-check"></i>{{ $productItem->inStock ? 'In Stock' : '' }}</span></span>
                        </div> --}}
                        <p class="mt-30px mb-0">{{ $productItem->product->product_description }}</p>
                        ...
                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                            <span>Category: </span>
                            {{ $productItem->product->category->category_name }}
                        </div>
